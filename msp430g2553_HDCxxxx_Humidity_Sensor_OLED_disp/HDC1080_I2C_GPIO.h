...
// HDC1080 - SCL : P2.0, SDA : P2.1
#define SCL_OUT     P2DIR |=  BIT0              //SCL Output
#define SCL_1       P2OUT |=  BIT0              //SCL = 1
#define SCL_0       P2OUT &=~ BIT0              //SCL = 0
#define SCL_PU      P2REN |= BIT0;

#define SDA_1       P2OUT |=  BIT1              //SDA = 1
#define SDA_0       P2OUT &=~ BIT1              //SDA = 0
#define SDA_IN      P2DIR &=~ BIT1             //SDA Input
#define SDA_OUT     P2DIR |=  BIT1              //SDA Output
#define SDA_READ    ((P2IN >> 1) & 0x01)        //Read SDA
#define SDA_PU      P2REN |= BIT1;
...
void HDC1080_I2C_read_temp_and_humidity(uint8_t slave_addr, uint16_t *temp_x10, uint16_t *humid_x10);
